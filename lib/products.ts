...
export const STANDALONE_PRODUCTS: StandaloneProduct[] = [
  {
    ...
    whatItIs: {
      ...
      points: [
        ...
        "A standalone purchase with clear pricing, no scheme paperwork.",
      ],
    },
    howItWorks: [
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "It's simple product-and-install pricing based on the system that suits your home. We will quote it clearly before you commit.",
      },
    ],
  },
];
